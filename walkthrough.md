...
- **[docs/recursive-proof-architecture.md](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/docs/recursive-proof-architecture.md)**
...
- **[crates/nova-aggregator/Cargo.toml](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/crates/nova-aggregator/Cargo.toml)**
- **[crates/nova-aggregator/src/lib.rs](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/crates/nova-aggregator/src/lib.rs)**
  - Defined `IvcState` $(i, \text{root}, \text{yes\_votes}, \text{no\_votes}, \text{acc\_nullifier\_hash})$, `VoteWitness`, and `RecursiveProofPayload`.
- **[crates/nova-aggregator/src/circuit.rs](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/crates/nova-aggregator/src/circuit.rs)**
...
- **[crates/nova-aggregator/src/aggregator.rs](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/crates/nova-aggregator/src/aggregator.rs)**
  - Implemented `NovaAggregator` for sequential IVC step folding and compressed proof output.
- **[crates/nova-aggregator/src/bin/main.rs](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/crates/nova-aggregator/src/bin/main.rs)**
  - Command-line interface for off-chain aggregation services.
- **[Cargo.toml](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/Cargo.toml)**
  - Added `"crates/nova-aggregator"` to workspace members.

### 3. Soroban Smart Contract Integration
- **[contracts/voting/src/lib.rs](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/contracts/voting/src/lib.rs)**
...
- **[contracts/voting/src/test.rs](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/contracts/voting/src/test.rs)**
...
- **[backend/src/services/nova-aggregator.ts](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/backend/src/services/nova-aggregator.ts)**
...
- **[backend/src/routes/nova.ts](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/backend/src/routes/nova.ts)**
  - Added `POST /api/v1/nova/aggregate` route for trigger-based vote proof aggregation.
- **[backend/src/routes/index.ts](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/backend/src/routes/index.ts)** & **[backend/src/index.ts](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/backend/src/index.ts)**
  - Re-exported and mounted `novaRoutes` on `/api/v1/nova`.

### 5. Benchmarking & Performance Suite
- **[crates/nova-aggregator/benches/nova_benchmark.rs](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/crates/nova-aggregator/benches/nova_benchmark.rs)**
  - Added Criterion benchmark suite for 1K vote folding.
- **[scripts/benchmark-recursive.js](file:///c:/Users/Harold%20Ikechukwu/Documents/drips-wave/ZK-VOTE/scripts/benchmark-recursive.js)**
